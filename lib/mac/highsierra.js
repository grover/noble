...
nobleBindings.on('kCBMsgId48', function (args) {
  ...
  var advertisement = {
    localName: args.kCBMsgArgName || args.kCBMsgArgAdvertisementData.kCBAdvDataLocalName,
 ...
 * @dicussion Not tested on MacOS HighSierra
 */
// This isn't the one for high sierra. Don't know which one it is though :(
nobleBindings.on('_kCBMsgId87_', function (args) {
  var deviceUuid = args.kCBMsgArgDeviceUUID.toString('hex');
